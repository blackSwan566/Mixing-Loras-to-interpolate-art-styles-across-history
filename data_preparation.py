...
# paths
image_data = "/Users/add your path/.../Mixing Loras for interpolating art styles across history/toy_dataset"  
csv = "/Users/add your path/.../Mixing Loras for interpolating art styles across history/toy_dataset_label.csv"  
...
def create_tar(tar_filename, start_date_epoch, end_date_epoch):
    ...
    with tarfile.open(tar_filename, "w") as tar:
        for _, row in labels.iterrows():
            ...
            if int(date_numbers) >= start_date_epoch and int(date_numbers) <= end_date_epoch:
...
# load webdatasets
dataset_middleage = wds.WebDataset("middleage_dataset.tar").decode("pil").to_tuple("jpg", "json")
dataset_middleage = wds.WebDataset("renaissance_dataset.tar").decode("pil").to_tuple("jpg", "json")
dataset_middleage = wds.WebDataset("barock_dataset.tar").decode("pil").to_tuple("jpg", "json")
